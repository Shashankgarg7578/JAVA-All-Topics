...
public class Coustom_SortingUsing_Comparator {

	public static void main(String[] args) {

		
		//It is used for comparing or custom sorting On key.
		...
		//It is used for comparing or custom sorting On Name length.
